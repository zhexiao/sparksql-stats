...
def run_sql_v():
    ...
    question_freq = s_questionv.get_question_freq_top_n_sqlv(faculty=3, subject=1)
    print(question_freq.toJSON().collect())
    ...
    knowledge_freq = s_cognitionv.get_knowledge_freq_top_n_sqlv(faculty=3, subject=1)
    print(knowledge_freq.toJSON().collect())
